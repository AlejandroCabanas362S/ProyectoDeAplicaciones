        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h2 class="text-white font-weight-light mb-2 display-1">¡Conoce nuestros servicios!</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Navaja de barbero</h3>
              <p>Disfruta de un afeitado tradicional con espuma caliente y navaja profesional.</p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Ubícanos fácilmente</h3>
              <p>Nuestra barbería está en el corazón de la ciudad. ¡Ven y relájate con nosotros!</p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Afeitado clásico</h3>
              <p>Un servicio completo para lograr un acabado suave y duradero.</p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Sillón de barbero</h3>
              <p>Relájate en nuestro sillón vintage mientras cuidamos hasta el último detalle.</p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Secado de cabello</h3>
              <p>Secado profesional para mantener tu estilo impecable todo el día.</p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5 mb-lg-5">
            <div class="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
              ...
              <h3 class="text-black h4">Spray de acabado</h3>
              <p>Fijación perfecta y aroma fresco que hará que tu peinado destaque.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5">
            <img src="images/person_1.jpg" alt="Imagen de cliente satisfecho" class="img-md-fluid">
          </div>
          <div class="col-lg-6 bg-white p-md-5 align-self-center">
            ...
            <p class="text-black lead"><em>&ldquo;IGNISIA transformó mi look por completo. El ambiente es acogedor y el equipo súper profesional. ¡Recomendado!&rdquo;</em></p>
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12">
            ...
            <p class="mb-0"><a href="#" class="btn btn-primary py-3 px-5 text-white">Visita nuestro salón hoy</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="mb-5">
              ...
              <p>Recibe novedades, promociones y tips de estilo directamente en tu correo.</p>
