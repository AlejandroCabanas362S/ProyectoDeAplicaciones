      ...
      <div class="container">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-borderless shadow-sm rounded bg-white">
            ...
            <tbody>
              <?php
              $result = $conn->query("SELECT * FROM reservas WHERE nombre = '$nombre'");
              $contador = 1;
              while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<form method='POST' action='bookingEdit.php'>";
                ...
                echo "<td><input type='text' name='servicioDeseado' value='" . htmlspecialchars($row['servicioDeseado']) . "' class='form-control form-control-sm' readonly></td>";
