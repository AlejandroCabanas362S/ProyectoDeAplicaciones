        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h2 class="text-white font-weight-light mb-2 display-1">Reserva en Línea</h2>
        ...
        <div class="row">
          <div class="col-md-7 mb-5">
            ...
            <form action="#" class="p-5 bg-white">
              <h2 class="mb-4 site-section-heading">Reserva Ahora</h2>
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" id="date" class="form-control datepicker px-2" placeholder="Fecha de visita">
                </div>
                <div class="col-md-6">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <select name="treatment" id="treatment" class="form-control">
                    ...
                    <option value="">Coloración de Cabello</option>
                    <option value="">Afeitado</option>
                    <option value="">Tratamiento Capilar</option>
                  </select>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black" for="note">Notas</label> 
                  <textarea name="note" id="note" cols="30" rows="5" class="form-control" placeholder="Escribe tus notas o preguntas aquí..."></textarea>
                </div>
              </div>
          ...
          <div class="col-md-5">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p>En IGNISIA nos especializamos en estilos personalizados, coloraciones creativas y tratamientos capilares de última generación. Reserva hoy y vive la experiencia.</p>
              <p><a href="#" class="btn btn-primary px-4 py-2 text-white">Contáctanos</a></p>
            </div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> Todos los derechos reservados
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
