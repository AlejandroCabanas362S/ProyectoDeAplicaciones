...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO usuarios (nombre, apellido, correo, usuario, contrasena, rol) VALUES (?, ?, ?, ?, ?, ?)");
                            ...
                            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                                ...
                                <?php if ($rol === 'admin' || $rol === 'emple'): ?>
                                    <li class="has-children">
                                        <a>Administración</a>
                                        <ul class="dropdown">
                                            <li class="active"><a href="register.php">Usuarios</a></li>
                ...
                <div class="row">
                    <div class="col-md-7 mb-5">
                        <form action="register.php" method="post" class="p-5 bg-white">
                            <h2 class="mb-4 site-section-heading">Agregar usuario</h2>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="txtapellido" placeholder="Apellido" class="form-control" required>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-6">
                                    <label class="text-black" for="treatment">Rol</label>
                                    <select type="text" name="txtrol" required class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="txtcorreo" placeholder="Correo" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="password" name="txtpassword" placeholder="Contraseña" class="form-control" required>
                                </div>
                            </div>
                    ...
                    <h2 class="mb-4 mt-5 site-section-heading">Lista de usuarios registrados</h2>
                    <div class="table-responsive">
                        <form method="post" action="registerEdit.php">
                            <table class="table table-hover table-borderless shadow-sm rounded bg-white">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<form method='POST' action='registerEdit.php'>";
                                        echo "<td class='align-middle text-center'>" . $contador++ . "</td>";
                                        echo "<td><input type='text' name='nombre' value='" . htmlspecialchars($row['nombre']) . "' class='form-control form-control-sm rounded-1 shadow-sm'></td>";
                                        echo "<td><input type='text' name='apellido' value='" . htmlspecialchars($row['apellido']) . "' class='form-control form-control-sm rounded-1 shadow-sm'></td>";
                                        echo "<td><input type='email' name='correo' value='" . htmlspecialchars($row['correo']) . "' class='form-control form-control-sm rounded-1 shadow-sm'></td>";
                                        echo "<td><input type='text' name='usuario' value='" . htmlspecialchars($row['usuario']) . "' class='form-control form-control-sm rounded-1 shadow-sm' readonly></td>";
                                        echo "<td>
                                            <select name='rol' class='form-control form-control-sm rounded-1 shadow-sm'>
                                                <option value='admin'" . ($row['rol'] == 'admin' ? ' selected' : '') . ">admin</option>
                                                <option value='emple'" . ($row['rol'] == 'emple' ? ' selected' : '') . ">emple</option>
