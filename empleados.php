...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO empleados (nombre, apellido, cargo, fecha_ingreso, sueldo, numero, correo) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssdds", $nombre, $apellido, $cargo, $fecha, $sueldo, $numero, $correo);
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 mb-5">
                        <form action="empleados.php" method="post" class="p-5 bg-white">
                            <h2 class="mb-4 site-section-heading">Agregar empleado</h2>
                            ...
                            <div class="row form-group">
                                <div class="col-md-6 mb-3">
                                    <label class="text-black">Cargo</label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-6 mb-3">
                                    <label class="text-black">Sueldo</label>
                            ...
                            <?php
                            if ($mensaje) {
                                echo "<div class='mt-2 text-success fw-bold'>$mensaje</div>";
                            }
                            ?>
                        </form>
                    ...
                    <h2 class="mb-4 mt-5 site-section-heading">Lista de empleados</h2>
                        ...
                        <table class="table table-hover table-borderless shadow-sm rounded bg-white">
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<form method='POST' action='empleadoEdit.php'>";
                                    ...
                                    echo "<td><input type='text' name='cargo' value='" . htmlspecialchars($row['cargo']) . "' class='form-control form-control-sm'></td>";
                                    echo "<td><input type='date' name='fecha_ingreso' value='" . htmlspecialchars($row['fecha_ingreso']) . "' class='form-control form-control-sm'></td>";
                                    echo "<td><input type='number' name='sueldo' value='" . htmlspecialchars($row['sueldo']) . "' class='form-control form-control-sm'></td>";
                                    echo "<td><input type='text' name='numero' value='" . htmlspecialchars($row['numero']) . "' class='form-control form-control-sm'></td>";
